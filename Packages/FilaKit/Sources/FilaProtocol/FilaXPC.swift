    ...
    public enum FilaXPC {
        public static var typeArray: xpc_type_t {
            fila_xpc_type_array()
        }
        ...
        public static var arrayAppend: Int {
            fila_xpc_array_append()
        }

        public static var errorConnectionInterrupted: xpc_object_t {
            fila_xpc_error_connection_interrupted()
        }

        public static var errorConnectionInvalid: xpc_object_t {
            fila_xpc_error_connection_invalid()
        }
    }
#endif
