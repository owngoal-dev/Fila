...
struct NetShareEnum {
    ...
    init(serverName: String) {
        ...
        preferredMaximumLength = 0xFFFF_FFFF
        resumeHandle = 0
    }
...
struct NetShareEnumResponse {
    ...
    struct ShareInfo1 {
        ...
        enum ShareType {
            static let diskTree: UInt32 = 0x0000_0000
            static let printQueue: UInt32 = 0x0000_0001
            static let device: UInt32 = 0x0000_0002
            static let ipc: UInt32 = 0x0000_0003
            static let clusterFS: UInt32 = 0x0200_0000
            static let clusterSOFS: UInt32 = 0x0400_0000
            static let clusterDFS: UInt32 = 0x0800_0000
            static let special: UInt32 = 0x8000_0000
            static let temporary: UInt32 = 0x4000_0000
        }
    }
}
