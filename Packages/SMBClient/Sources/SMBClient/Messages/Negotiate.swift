...
public enum Negotiate {
    ...
    public struct Capabilities: OptionSet, Sendable {
        ...
        public static let dfs = Capabilities(rawValue: 0x0000_0001)
        public static let leasing = Capabilities(rawValue: 0x0000_0002)
        public static let largeMtu = Capabilities(rawValue: 0x0000_0004)
        public static let multiChannel = Capabilities(rawValue: 0x0000_0008)
        public static let persistentHandles = Capabilities(rawValue: 0x0000_0010)
        public static let directoryLeasing = Capabilities(rawValue: 0x0000_0020)
        public static let encryption = Capabilities(rawValue: 0x0000_0040)
        public static let notifications = Capabilities(rawValue: 0x0000_0080)
    }
