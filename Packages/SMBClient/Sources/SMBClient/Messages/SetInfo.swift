...
public enum SetInfo {
    public struct Request: Message.Request {
        ...
        public struct Flags: OptionSet {
            ...
            public static let replaceIfExists = Flags(rawValue: 0x0000_0001)
            public static let advanceOnly = Flags(rawValue: 0x0000_0002)
        }
        ...
        public init(
            ...
            fileInfoClass = fileInformation.infoClass
