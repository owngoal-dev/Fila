...
public enum Read {
    ...
    public enum Channel: UInt32 {
        ...
        case rdmaV1 = 0x0000_0001
        case rdmaV1Invalidate = 0x0000_0002
    }

    public enum ReadFlag: UInt32 {
        case responseNone = 0x0000_0000
        case responseRdmaTransform = 0x0000_0001
    }
}
