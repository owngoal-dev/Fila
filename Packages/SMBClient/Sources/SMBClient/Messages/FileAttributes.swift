...
public struct FileAttributes: OptionSet, Sendable {
    ...
    public static let integrityStream = FileAttributes(rawValue: 0x0000_8000)
    public static let noScrubData = FileAttributes(rawValue: 0x0002_0000)
    public static let recallOnOpen = FileAttributes(rawValue: 0x0004_0000)
    public static let pinned = FileAttributes(rawValue: 0x0008_0000)
    public static let unpinned = FileAttributes(rawValue: 0x0010_0000)
    public static let recallOnDataAccess = FileAttributes(rawValue: 0x0040_0000)
}
