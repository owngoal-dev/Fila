...
public struct Header {
    ...
    public struct Flags: OptionSet, Sendable {
        ...
        public static let serverToRedir = Flags(rawValue: 0x0000_0001)
        public static let asyncCommand = Flags(rawValue: 0x0000_0002)
        public static let relatedOperations = Flags(rawValue: 0x0000_0004)
        public static let signed = Flags(rawValue: 0x0000_0008)
        public static let priorityMask = Flags(rawValue: 0x0000_0070)
        public static let dfsOperation = Flags(rawValue: 0x1000_0000)
        public static let replayOperation = Flags(rawValue: 0x2000_0000)
    }
}
