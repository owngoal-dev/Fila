...
public class Session {
  ...
  // Fila: one QUERY_DIRECTORY request against a directory handle the caller
  // opened with `create(... createOptions: [.directoryFile] ...)` and will
  // `close`. `queryDirectory(path:pattern:)` above collects the whole
