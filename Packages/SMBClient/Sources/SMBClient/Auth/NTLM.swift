...
public enum NTLM {
    public struct NegotiateMessage {
        ...
        public init(
            ...
            signature = 0x0050_5353_4D4C_544E
            messageType = 0x0000_0001
            ...
            workstationNameFields = Fields(oemEncoding: workstationName, offset: domainNameFields.nextOffset)

            version = 0x0000_0000_0000_0000
        }
    ...
    public struct ChallengeMessage {
        ...
        func ntowfv2(
            ...
            return Crypto.hmacMD5(key: Crypto.md4(passwordData), data: usernameData)
        }
    ...
    public struct NegotiateFlags: OptionSet, Sendable {
        ...
        public static let negotiate56 = NegotiateFlags(rawValue: 0x8000_0000)
        public static let negotiateKeyExchange = NegotiateFlags(rawValue: 0x4000_0000)
        public static let negotiate128 = NegotiateFlags(rawValue: 0x2000_0000)
        public static let negotiateVersion = NegotiateFlags(rawValue: 0x0200_0000)
        public static let negotiateTargetInfo = NegotiateFlags(rawValue: 0x0080_0000)
        public static let requestNonNTSessionKey = NegotiateFlags(rawValue: 0x0040_0000)
        public static let negotiateIdentify = NegotiateFlags(rawValue: 0x0010_0000)
        public static let negotiateExtendedSecurity = NegotiateFlags(rawValue: 0x0008_0000)
        public static let negotiateTargetTypeServer = NegotiateFlags(rawValue: 0x0002_0000)
        public static let negotiateTargetTypeDomain = NegotiateFlags(rawValue: 0x0001_0000)
        public static let negotiateAlwaysSign = NegotiateFlags(rawValue: 0x0000_8000)
        public static let negotiateOemWorkstationSupplied = NegotiateFlags(rawValue: 0x0000_2000)
        public static let negotiateOemDomainSupplied = NegotiateFlags(rawValue: 0x0000_1000)
        public static let negotiateAnonymous = NegotiateFlags(rawValue: 0x0000_0800)
        public static let negotiateNetware = NegotiateFlags(rawValue: 0x0000_0200)
        public static let negotiateLanManagerKey = NegotiateFlags(rawValue: 0x0000_0080)
        public static let negotiateDatagramStyle = NegotiateFlags(rawValue: 0x0000_0040)
        public static let negotiateSeal = NegotiateFlags(rawValue: 0x0000_0020)
        public static let negotiateSign = NegotiateFlags(rawValue: 0x0000_0010)
        public static let requestTarget = NegotiateFlags(rawValue: 0x0000_0004)
        public static let oem = NegotiateFlags(rawValue: 0x0000_0002)
        public static let unicode = NegotiateFlags(rawValue: 0x0000_0001)
    }
