const en = {
  ...
  invalid: 'Names cannot contain “/” or be “.” or “..”.',
  deleteTitle: 'Permanently Delete Items?',
  deleteWarning:
    'These items and all folder contents will be permanently deleted. This cannot be undone.',
