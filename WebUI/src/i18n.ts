const en = {
  ...
  loading: 'Loading…',
  folders: 'This folder has no subfolders. Choose it or open another folder.',
  ...
  partial: (n: number) => `${n} completed before this stopped.`,
  ...
  up: 'Parent Folder',
  uncertain: 'The result is unknown. Refresh before trying again.',
...
const zh: Words = {
  ...
  loading: '正在加载…',
  folders: '此文件夹没有子文件夹。请选择此文件夹或打开其他文件夹。',
  selected: (n) => `已选择 ${n} 项`,
  items: (n) => `${n} 项`,
  done: (n) => `已完成 ${n} 项。`,
